...
export const NewPost = () => {
    ...
    return (
        <>
            ...
            <Header />
            <section className={`container mx-auto rounded-xl  mt-20 flex flex-col h-[65vh]`}>
                <div className={`flex flex-col justify-center items-center mt-15`}>
                    ...
                    <form className="flex flex-col  max-w-2xl ">
                        <div >
                            <label className="text-[#b87d00] dark:text-[#ffc855]">
                                <p >Título<span className=" text-red-500 font-bold "> *</span> </p>
                                <input
                                    type="text"
                                    ...
                                    required
                                    className={`
                                     w-[19em] md:w-[40em] border-2 border-gray-300 py-2 rounded-md px-2 mt-2 outline-2 outline-[#b87d00]  transition-all duration-500
                        ...
                        <div className=" mt-5">
                            <label >
                                <p className="text-[#b87d00] dark:text-[#ffc855]"> Corpo<span className=" text-red-500 font-bold "> *</span> </p>
                                <textarea
                                    cols={30} rows={6}
                                    minLength={2}
                                    maxLength={150}
                                    ...
                                    className={` resize-none w-[19em] md:w-[40em] border-2 mt-2 border-gray-300 rounded-md outline-2 outline-[#b87d00] p-2
                        ...
                        mt-6 text-white opacity-70 hover:opacity-100 transition-all duration-500
                        `}
