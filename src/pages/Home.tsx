        ...
        <>
            ...
            `} >
                <div className={styles.bannerOpacity}>
                    ...
                    <section className="h-[80vh] container mx-auto flex flex-col justify-center items-center px-2 md:items-start md:px-8">
                        <h2 className={` font-bold text-5xl 2xl:text-5xl mb-5 text-white`}>Blogs</h2>
